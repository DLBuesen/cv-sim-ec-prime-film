...
docker run -ti --entrypoint="/bin/bash" --user nonroot --env DISPLAY=%IPv4%:%XLaunchScreenID% -p 127.0.0.1:8000:8000 -v "%cd%":/home/nonroot/project -w /home/nonroot/project/src dlbuesen/cv_sim_ec-prime-film:version-1.0.0-layer08
